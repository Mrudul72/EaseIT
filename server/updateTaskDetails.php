...
if ($task_title != $title) {
    ...
    $query2 = "INSERT INTO tbl_activity (activity_type, activity_by, activity_desc,project_id) VALUES ('task', '$uid', '$activity_desc', '$proID')";
    $res2 = mysqli_query($connect, $query2);
}
if ($task_description != $desc) {
    $activity_desc = "{$userName} changed description of task \'{$title}\'";
    //insert to activity table
    $query3 = "INSERT INTO tbl_activity (activity_type, activity_by, activity_desc,project_id) VALUES ('task', '$uid', '$activity_desc', '$proID')";
...
if (!isset($_FILES['attachment']) || $_FILES['attachment']['error'] == UPLOAD_ERR_NO_FILE) {
    ...
    //insert to activity table
    $query4 = "INSERT INTO tbl_activity (activity_type, activity_by, activity_desc,project_id) VALUES ('file', '$uid', '$activity_desc', '$proID')";
