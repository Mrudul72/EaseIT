...
$updatePermission = ($_SESSION['currentUserTypeId'] == '2') ? '' : 'readonly';
    ...
    <div class="row">
        <div class="col-8">
            <div class="form-group">
                ...
                <textarea '.$updatePermission.' name="task-detail-title" id="task-detail-title" class="form-control" placeholder="task title"
            ...
            <div class=" form-group">
                ...
                <textarea '.$updatePermission.' rows="8" id="task-detail-description" row="auto" name="task-detail-description"
